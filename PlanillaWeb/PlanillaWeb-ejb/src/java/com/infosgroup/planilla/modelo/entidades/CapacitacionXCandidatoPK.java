...
public class CapacitacionXCandidatoPK implements Serializable {
    ...
    public String toString() {
        return "com.infosgroup.planilla.modelo.entidades.planilla.CapacitacionXCandidatoPK[ codCia=" + codCia + ", codCandidato=" + codCandidato + ", codCapacitacion=" + codCapacitacion + " ]";
    }

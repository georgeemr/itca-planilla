...
public class SubNivelAcademicoPK implements Serializable {
    ...
    public String toString() {
        return "com.infosgroup.planilla.modelo.entidades.planilla.SubNivelAcademicoPK[ codCia=" + codCia + ", codNivelAcademico=" + codNivelAcademico + ", subNivelAcademico=" + subNivelAcademico + " ]";
    }

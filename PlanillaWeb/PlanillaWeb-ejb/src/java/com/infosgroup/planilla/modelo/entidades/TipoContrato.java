...
public class TipoContrato implements Serializable
{
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "tipoContrato", fetch = FetchType.EAGER)
    ...
    public boolean equals(Object object)
    {
        ...
        if ((this.tipoContratoPK == null && other.tipoContratoPK != null) || (this.tipoContratoPK != null && !this.tipoContratoPK.equals(other.tipoContratoPK))) return false;
        return true;
    }

...
if (actual < nuevo)
    ...
    if (nuevo < 999)
        ...
        getSessionBeanEMP().setFactor(detalle.getFactor());
        }
    }
...
{
return empleadosBean.cerrarEvaluacion(sessionBeanEMP.getCampania(), sessionBeanEMP.getTipoEvaluacion(), sessionBeanEMP.getPlantilla(), sessionBeanEMP.getEmpleado(), sessionBeanEMP.getDetalleEvaluacionTemporal()) ? inicio$action() : null;
}

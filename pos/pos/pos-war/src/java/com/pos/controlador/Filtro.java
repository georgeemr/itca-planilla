 ...
 * @author Soporte
 */
@WebFilter(filterName = "Filtro", urlPatterns = {"*.xhtml"}, dispatcherTypes = {DispatcherType.REQUEST})
...
//            if (/*wrappedRequest.getRequestURI().endsWith("/") ||*/ wrappedRequest.getRequestURI().endsWith("index.xhtml") || wrappedRequest.getRequestURI().endsWith("logout.xhtml") || wrappedRequest.getRequestURI().endsWith("noPermiso.xhtml")) {
//                chain.doFilter(wrappedRequest, wrappedResponse);
//            } else {
//                //wrappedResponse.sendRedirect("noPermiso.xhtml");
//                  chain.doFilter(wrappedRequest, wrappedResponse);
//            }

            /* Solo debe pasar una vez */
